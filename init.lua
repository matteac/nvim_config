        ...
        tsserver = {
          on_attach = function(client, _)
            if vim.fn.filereadable(vim.fn.getcwd() .. "/deno.json") == 1 then
              client.stop()
              print("Deno project, tsserver stopped")
            end
          end
        },
        lua_ls = {
...
vim.o.smarttab = true  -- Use shiftwidth for <Tab> at the beginning of a line

-- Modeline settings
vim.opt.modeline = true -- Enable modeline
vim.opt.modelines = 5   -- Scan 5 lines from top and bottom for modelines

-- Disable special indentation characters in listchars
vim.opt.list = false -- Disable list mode to avoid showing any special characters
